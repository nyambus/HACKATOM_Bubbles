...
# Установка Apache2
apt install apache2 unzip nginx ssh wget python3-pip -y
...
FLUSH PRIVILEGES;
CREATE DATABASE personal_data_users;
...
INSERT INTO user_personal_data (name) VALUES ('atgk{hgfqktkxrhklzbgwx}');
EOF
